...
class Arena implements Listener {
	...
	public function giveSet(){
		foreach ($this->players as $player) {
			...
			$kitData = $this->plugin->getConfig()->getAll()["kits"][$this->kit];
			$inv->setHelmet(Item::get($kitData["helmet"][0], $kitData["helmet"][1], $kitData["helmet"][2]));
			$inv->setChestplate(Item::get($kitData["chestplate"][0], $kitData["chestplate"][1], $kitData["chestplate"][2]));
			$inv->setLeggings(Item::get($kitData["leggings"][0], $kitData["leggings"][1], $kitData["leggings"][2]));
			$inv->setBoots(Item::get($kitData["boots"][0], $kitData["boots"][1], $kitData["boots"][2]));
    ...
    public function loadArena(bool $restart = false) {
        ...
        $keys = array_keys($this->plugin->getConfig()->getAll()["kits"]);
